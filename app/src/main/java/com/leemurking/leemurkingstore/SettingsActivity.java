...
//        ref.child(com.leemurking.leemurkingstore.Prevalent.currentOnlineUser.getPhone()).updateChildren(userMap);
...
//                    .child(com.leemurking.leemurkingstore.Prevalent.currentOnlineUser.getPhone() + ".jpg");
//
