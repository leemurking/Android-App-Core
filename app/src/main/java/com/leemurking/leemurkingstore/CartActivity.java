...
//                                .child(com.leemurking.leemurkingstore.Prevalent.currentOnlineUser.getPhone()).child("Products"),Cart.class).build();
...
//                                            .child(com.leemurking.leemurkingstore.Prevalent.currentOnlineUser.getPhone())
//                                            .child("Products")
//                                            .child(model.getPid())
//                                            .removeValue()
...
//        ordersRef = FirebaseDatabase.getInstance().getReference().child("Orders").child(com.leemurking.leemurkingstore.Prevalent.currentOnlineUser.getPhone());
